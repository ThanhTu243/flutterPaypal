...
paypal.configure({
    'mode': 'sandbox',
    'client_id':'AQ3ik5FigxrjAx_-clHYQAoyA8nCaZBg3y4EoCXzVt1XmuVaKJ_xxjk3Y1W7QgUkgC3csVMCzwUk2KSn',
    'client_secret':'EGhjleaPGTk488zBtzotK8Xv8iMPiFX_HMZQ-Px3ObPP9HOMpO-kFkx90NWdCcL8KYEeGrxqK0Wx8Vtp'
});
...
route.get('/createpaypalpayment', async (req, res) => {
    ...
    var create_payment_json = {
        ...
        /// 
        "redirect_urls": {
            "return_url": `http://192.168.8.1:3000/execute?amount=${amount}&currency=${currency}`,
